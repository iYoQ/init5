...
from src.comments.viewsets import ArticleCommentViewSet, NewsCommentViewSet, UserCommentsList
...
router.register('users/(?P<username>[^/.]+)/comments', UserCommentsList, basename='user_comments')
